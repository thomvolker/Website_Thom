...
create_CV_object <-  function(data_location,
  ...
  if(is_google_sheets_location){
    ...
    cv$entries_data <- readr::read_csv2(paste0(data_location, "entries.csv"), skip = 1)
    cv$skills       <- readr::read_csv2(paste0(data_location, "language_skills.csv"), skip = 1)
    cv$text_blocks  <- readr::read_csv2(paste0(data_location, "text_blocks.csv"), skip = 1)
    cv$contact_info <- readr::read_csv2(paste0(data_location, "contact_info.csv"), skip = 1)
  }
